...
def user_list():
    ...
    # Render the user list template with the retrieved users
...
def update_user(user_id):
    if request.method == 'POST':
        ...
        sql = "UPDATE user SET first_name = %s, last_name = %s, email = %s, mobile_number = %s WHERE id = %s"
        values = (first_name, last_name, email, mobile_number, user_id)
        cursor.execute(sql, values)
    ...
    # Render the update user template with the retrieved user
